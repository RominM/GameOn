...
const modalBtn = document.querySelectorAll(".modal-btn"); //je m'inscris
const formData = document.querySelectorAll(".formData");//formulaire
const cross = document.querySelector('.close');//croix ferme formulaire
//FORM ELEMENTS
const firstName = document.querySelector('#first');//prenom
const lastName = document.querySelector('#last');//nom
const email = document.querySelector('#email');//email
const submitBtn = document.querySelector('#submitBtn');//boutton "c'est partie"
...
const checkInputFirstName = () => {
   if (firstName.value.length > 2) {
      ...
      result.firstName.status = true;
   }
   else {
      result.firstName.data = firstName.value;
      result.firstName.status = false;
   }
}
...
const checkInputLastName = () => {
   if (lastName.value.length > 2) {
      ...
      result.lastName.status = true;
   }
   else {
      result.lastName.data = lastName.value;
      result.lastName.status = false;
   }
}
